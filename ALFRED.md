...
3. Multi-GPU
   ...
   - Distributed Adam, param shape groups, gradient sync
4. BOS alignment
5. Muon
...
- winter-voice-6, colab t4, VF=4, #1, 77s/step, ~14.1GB max mem
- wise-blaze-7, colab t4, VF=4, #2 (bf16 loss), ~13.3GB max mem
- 